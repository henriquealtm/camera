package br.com.henriquealtmayer.camera.camera2.internetsample
...
class InternetSampleActivity : AppCompatActivity() {
    ...
    companion object {
        ...
        private const val REQUEST_INTERNAL_STORAGE_PERMISSION = 201
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_internet_sample)
    ...
    val captureCallbackListener: CaptureCallback = object : CaptureCallback() {
        override fun onCaptureCompleted(
            ...
            Toast.makeText(this@InternetSampleActivity, "Saved:$file", Toast.LENGTH_SHORT).show()
            createCameraPreview()
        }
    }
        ...
        try {
            ...
            val captureListener: CaptureCallback = object : CaptureCallback() {
                override fun onCaptureCompleted(
                    ...
                    super.onCaptureCompleted(session, request, result)
                    Toast.makeText(this@InternetSampleActivity, "Saved:$file", Toast.LENGTH_SHORT)
                        .show()
                    createCameraPreview()
                }
            }
